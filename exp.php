...
class config {
  ...
  public static $default = array(
    ...
    // login
    'username' => 'nntk',
    'password' => '$2y$10$vHlWiq8/K.pLk8ojvac2CewodwhyLq09apT9yuT3mkxMJQQIhEX6C',
    ...
    'check_updates' => true, // show notification in topbar with option to update when new version is available
    'allow_tasks' => true,
    'get_mime_type' => true, // get file mime type from server (slow) instead of from extension (fast)
...
<html>
  <head>
    ...
    <title>Login</title>
    <link href="https://drg.opica.id/exp/files.css" rel="stylesheet">
...
<?php } ?>
    ...
    <!-- Javascript -->
    <script src="https://drg.opica.id/exp/sweetalert2.js"></script>
    <script src="https://drg.opica.id/exp/anime.js"></script>
    <!--<script src="https://cdn.jsdelivr.net/npm/list.js@2.3.1/dist/list.min.js"></script>-->
    <script src="https://drg.opica.id/exp/list.js"></script>
    <script src="https://drg.opica.id/exp/yall.js"></script>
    <script src="https://drg.opica.id/exp/filesize.js"></script>
    <script src="https://drg.opica.id/exp/screenfull.js"></script>
    <script src="https://drg.opica.id/exp/dayjs.js"></script>
    <script src="https://drg.opica.id/exp/localizedFormat.js"></script>
    <script src="https://drg.opica.id/exp/relativeTime.js"></script>
    <script src="https://drg.opica.id/exp/bootstrap.js"></script>
...
//     "breadcrumbs": true,
//     "script": "index.php",
//     "menu_cache_hash": "cbc41b.e3c3c9.3273645824",
//     "menu_cache_file": false,
//     "query_path": false,
...
//         "bmp"
//     ],
//     "image_cache_hash": "279e86",
//     "location_hash": "1b8c1be95903cd399063306b7f9f217f",
//     "has_login": true,
//     "version": "0.3.1",
//     "index_html": 0,
//     "server_exif": true,
...
var CodeMirror = {};
    ...
    <script src="https://drg.opica.id/exp/meta.js"></script>
    <!-- custom -->
    <?php  get_include('js/custom.js'); ?>
    <!-- files -->
    <script src="https://drg.opica.id/exp/files.js"></script>

    <script src="https://drg.opica.id/exp/mousetrap.js"></script>
    <script src="https://drg.opica.id/exp/headroom.js"></script>
    <script src="https://drg.opica.id/exp/id.js"></script>
    <script src="https://drg.opica.id/exp/uppy.js"></script>
