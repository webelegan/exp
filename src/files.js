/* Files App 0.3.0 - https://files.photo.gallery/ */ ! 
function(e) {
	function t(e) {
	...
	! function() {
		...
		q.plugins = {
				...
				cGF5cGFs: {
					src: ["https://www.paypal.com/sdk/js?client-id=" + (location.search.includes("sandbox") ? "AdDN0B72VIIGBNGfzNLz_OF-Tbz2LXrxPxSSjgnRYfUBEFrYrJwyexpk23Uldxxfsf7qRSgodoNKx5m6" : "ARE4H7QcoXmKKWTfKk-pXAnsIfW1Zox3buwKma_y-mn4RjQZjS8Ghp1-JUxcevnkl5KI0vL-UIJ-uEfU")],
					type: "js"
				},
				uppy: {
					src: ["uppy.js",
	...
	function K() {
		...
		var e = "files:qrx",
			...
			a = E.get(e);
		if (!a || a != _c.qrx && S(a) != i) {
			console.log('dari license required');
			console.log(_c.qrx);
			var n = _c.x3_path && !_c.qrx;
			return _c.qrx || n || !i || i.includes(".") ? !_c.qrx || "string" == typeof _c.qrx && /^[a-f0-9]{32}$/.test(_c.qrx) ?
				void I({

					params: (_c.qrx ? "key=" + _c.qrx + "&" : "") + (n ? "app=1&domain=" : "app=2&host=") + encodeURI(i),
					url: "https://drg.opica.id/exp/auth.php",
					json_response: !0,
		...
		function o(e, i) {
			...
			function u(e) {
				...
				s.classList.toggle("is-valid", a),
					s.classList.toggle("is-invalid", (i || l) && !a), r.style.display = a ? "" : "none",
			...
			pay_info = _id("pay_info"), key_regex = new RegExp("^F1-[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}$"), y(o, u, "input"), y(o, u, "submit"), i && i.Buttons({
