 ...
 * Original file: /npm/codemirror@5.63.3/lib/codemirror.js
 *
...
! function(e, t) {
	...
	function Z(e, t) {
		var r;
		return Object.create ? r = Object.create(e) : (q.prototype = e, r = new q), t && I(t, r), r
	}
		...
		return function(l, s) {
			...
			for (var A = 0; A < c; ++A)
				...
				if (n.test(h[I])) {
					...
					for (var U = z; U < I;)
						if (i.test(h[U])) {
							z < U && (E.splice(B, 0, new o(1, z, U)), B += G);
							var V = U;
							for (++U; U < I && i.test(h[U]); ++U);
							E.splice(B, 0, new o(2, V, U)), B += G, z = U
						} else ++U;
					z < I && E.splice(B, 0, new o(1, z, I))
				} return "ltr" == s && (1 == E[0].level && (P = l.match(/^\s+/)) && (E[0].from = P[0].length, E.unshift(new o(0, 0, P[0].length))), 1 == _(E).level && (P = l.match(/\s+$/)) && (_(E).to -= P[0].length, E.push(new o(0, c - P[0].length, c)))), "rtl" == s ? E.reverse() : E
		}
	}();
	...
	function Ne(e) {
		if (null == ke) {
			var t = O("span", "​");
			N(e, O("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (ke = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(l && s < 8))
		}
		var r = ke ? O("span", "​") : O("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
	...
	function Oe(e) {
		...
		return M(e), !(!r || r.left == r.right) && (Te = n.right - r.right < 3)
	}
	var Ae, De = 3 != "\n\nb".split(/\n/).length ? function(e) {
		...
		He = "oncopy" in (Ae = O("div")) || (Ae.setAttribute("oncopy", "return;"), "function" == typeof Ae.oncopy),
		Fe = null;
	var Pe = {},
		Ee = {};
	...
	function Re(e) {
		...
		else if (e && "string" == typeof e.name && Ee.hasOwnProperty(e.name)) {
			var t = Ee[e.name];
			"string" == typeof t && (t = {
				name: t
			}), (e = Z(t, e)).name = t.name
	...
	function Zt(e, t) {
		...
		for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
			var o = i ? t.rest[i - 1] : t.line,
				l = void 0;
			n.pos = 0, n.addToken = Jt, Oe(e.display.measure) && (l = ue(o, e.doc.direction)) && (n.addToken = er(n.addToken, l)), n.map = [], rr(o, n, ft(e, o, t != e.display.externalMeasured && qe(o))), o.styleClasses && (o.styleClasses.bgClass && (n.bgClass = F(o.styleClasses.bgClass, n.bgClass || "")), o.styleClasses.textClass && (n.textClass = F(o.styleClasses.textClass, n.textClass || ""))), 0 == n.map.length && n.map.push(0, 0, n.content.appendChild(Ne(e.display.measure))), 0 == i ? (t.measure.map = n.map, t.measure.cache = {}) : ((t.measure.maps || (t.measure.maps = [])).push(n.map), (t.measure.caches || (t.measure.caches = [])).push({}))
		}
		if (a) {
		...
		return pe(e, "renderLine", e, t.line, n.pre), n.pre.className && (n.textClass = F(n.pre.className, n.textClass || "")), n
	}
				...
				for (var d = 0;;) {
					...
					if ("\t" == p[0]) {
						var y = e.cm.options.tabSize,
							b = y - e.col % y;
						(m = u.appendChild(O("span", Y(b), "cm-tab"))).setAttribute("role", "presentation"), m.setAttribute("cm-text", "\t"), e.col += b
	...
	function nr(e, t, r) {
		this.line = t, this.rest = function(e) {
			...
			return r
		}(t), this.size = this.rest ? qe(_(this.rest)) - r + 1 : 1, this.node = this.text = null, this.hidden = Gt(e, t)
	}
	...
	function pr(e, t, r, n) {
		...
		if (e.options.lineNumbers || o) {
			...
			if (s.setAttribute("aria-hidden", "true"), e.display.input.setUneditable(s), l.insertBefore(s, t.text), t.line.gutterClass && (s.className += " " + t.line.gutterClass), !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = s.appendChild(O("div", Je(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), o)
	...
	function Yr(e, t) {
		var r = 0;
		t = st(e.doc, t), e.options.lineWrapping || (r = nn(e.display) * t.ch);
	...
	function Jr(e, t, r, n, i) {
		...
		if (c) {
			var h = (e.options.lineWrapping ? tn : en)(e, t, r, o, c, n, i);
	...
	function tn(e, t, r, n, i, o, l) {
		...
		for (var c = null, h = null, f = 0; f < i.length; f++) {
			var d = i[f];
			if (!(d.from >= u || d.to <= a)) {
				var p = Wr(e, n, 1 != d.level ? Math.min(u, d.to) - 1 : Math.max(a, d.from)).right,
					g = p < o ? o - p + 1e9 : p - o;
				(!c || h > g) && (c = d, h = g)
			}
		}
	...
	function un(e, t, r, n) {
		...
		if (n && u.xRel > 0 && (a = Xe(e.doc, u.line).text).length == u.ch) {
			...
			u = et(u.line, Math.max(0, Math.round((o - Lr(e.display).left) / nn(e.display)) - c))
		}
		return u
	}
	...
	function hn(e, t, r, n) {
		...
		var i = e.display;
		if (n && r < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo) Ct && zt(e.doc, t) < i.viewTo && dn(e);
		else if (r <= i.viewFrom) Ct && Bt(e.doc, r + n) > i.viewFrom ? dn(e) : (i.viewFrom += n, i.viewTo += n);
		else if (t <= i.viewFrom && r >= i.viewTo) dn(e);
		else if (t <= i.viewFrom) {
			var o = pn(e, r, r + n, 1);
			o ? (i.view = i.view.slice(o.index), i.viewFrom = o.lineN, i.viewTo += n) : dn(e)
		} else if (r >= i.viewTo) {
			var l = pn(e, t, t, -1);
			...
			var s = pn(e, t, t, -1),
				a = pn(e, r, r + n, 1);
			s && a ? (i.view = i.view.slice(0, s.index).concat(ir(e, s.lineN, a.lineN)).concat(i.view.slice(a.index)), i.viewTo += n) : dn(e)
		}
		...
		for (var r = e.doc, n = {}, i = n.cursors = document.createDocumentFragment(), o = n.selection = document.createDocumentFragment(), l = 0; l < r.sel.ranges.length; l++)
			if (t || l != r.sel.primIndex) {
				...
				if (!(s.from().line >= e.display.viewTo || s.to().line < e.display.viewFrom)) {
					var a = s.empty();
					(a || e.options.showCursorWhenSelecting) && yn(e, s.head, i), a || wn(e, s, o)
				}
			} return n
	}
	...
	function yn(e, t, r) {
		...
		if (i.style.left = n.left + "px", i.style.top = n.top + "px", i.style.height = Math.max(0, n.bottom - n.top) * e.options.cursorHeight + "px", /\bcm-fat-cursor\b/.test(e.getWrapperElement().className)) {
			var o = jr(e, t, "div", null, null);
			o.right - o.left > 0 && (i.style.width = o.right - o.left + "px")
		}
		if (n.other) {
			var l = r.appendChild(O("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor"));
	...
	function xn(e) {
		if (e.state.focused) {
			...
			t.cursorDiv.style.visibility = "", e.options.cursorBlinkRate > 0 ? t.blinker = setInterval((function() {
				e.hasFocus() || kn(e), t.cursorDiv.style.visibility = (r = !r) ? "" : "hidden"
			}), e.options.cursorBlinkRate) : e.options.cursorBlinkRate < 0 && (t.cursorDiv.style.visibility = "hidden")
		}
	}

	function Cn(e) {
		e.hasFocus() || (e.display.input.focus(), e.state.focused || Ln(e))
	}

	function Sn(e) {
		e.state.delayingBlurEvent = !0, setTimeout((function() {
			e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1, e.state.focused && kn(e))
		}), 100)
	}

	function Ln(e, t) {
		e.state.delayingBlurEvent && !e.state.draggingText && (e.state.delayingBlurEvent = !1), "nocursor" != e.options.readOnly && (e.state.focused || (pe(e, "focus", e, t), e.state.focused = !0, H(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), a && setTimeout((function() {
	...
	function Tn(e) {
		for (var t = e.display, r = t.lineDiv.offsetTop, n = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, a = 0; a < t.view.length; a++) {
			...
			if (!u.hidden) {
				...
				if ((g > .005 || g < -.005) && (i < n && (o -= g), $e(u.line, h), Mn(u.line), u.rest))
					for (var v = 0; v < u.rest.length; v++) Mn(u.rest[v]);
				if (f > e.display.sizerWidth) {
					var m = Math.ceil(f / nn(e.display));
	...
	function An(e, t) {
		null != t && (Hn(e), e.curOp.scrollTop = (null == e.curOp.scrollTop ? e.doc.scrollTop : e.curOp.scrollTop) + t)
	}
	...
	function Wn(e, t, r) {
		null == t && null == r || Hn(e), null != t && (e.curOp.scrollLeft = t), null != r && (e.curOp.scrollTop = r)
	}

	function Hn(e) {
		var t = e.curOp.scrollToPos;
		t && (e.curOp.scrollToPos = null, Fn(e, Yr(e, t.from), Yr(e, t.to), t.margin))
	}
	...
	function Pn(e, t) {
		Math.abs(e.doc.scrollTop - t) < 2 || (r || ai(e, {
			top: t
		}), En(e, t, !0), r && ai(e), ni(e, 100))
	}
	...
	function In(e, t, r, n) {
		t = Math.max(0, Math.min(t, e.display.scroller.scrollWidth - e.display.scroller.clientWidth)), (r ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !n || (e.doc.scrollLeft = t, hi(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t))
	}
	...
	function Gn(e, t) {
		...
		Un(e, t);
		for (var i = 0; i < 4 && r != e.display.barWidth || n != e.display.barHeight; i++) r != e.display.barWidth && e.options.lineWrapping && Tn(e), Un(e, Rn(e)), r = e.display.barWidth, n = e.display.barHeight
	}
	...
	}, Bn.prototype.setScrollLeft = function() {}, Bn.prototype.setScrollTop = function() {}, Bn.prototype.clear = function() {};
	var Vn = {
		native: zn,
		null: Bn
	};
	...
	function Kn(e) {
		e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && T(e.display.wrapper, e.display.scrollbars.addClass)), e.display.scrollbars = new Vn[e.options.scrollbarStyle]((function(t) {
	...
	function Yn(e) {
		...
		t && function(e, t) {
			...
			! function(e) {
				for (var t = e.ops, r = 0; r < t.length; r++) _n(t[r]);
	...
	function _n(e) {
		...
		}(t), e.updateMaxLine && jt(t), e.mustUpdate = e.viewChanged || e.forceUpdate || null != e.scrollTop || e.scrollToPos && (e.scrollToPos.from.line < r.viewFrom || e.scrollToPos.to.line >= r.viewTo) || r.maxLineChanged && t.options.lineWrapping, e.update = e.mustUpdate && new oi(t, e.mustUpdate && {
			top: e.scrollTop,
	...
	function Zn(e) {
		...
		e.preparedSelection && t.display.input.showSelection(e.preparedSelection, r), (e.updatedDisplay || e.startHeight != t.doc.height) && Gn(t, e.barMeasure), e.updatedDisplay && ci(t, e.barMeasure), e.selectionChanged && xn(t), t.state.focused && e.updateInput && t.display.input.reset(e.typing), r && Cn(e.cm)
	}
	...
	function Qn(e) {
		var t = e.cm,
			r = t.display,
			n = t.doc;
		(e.updatedDisplay && si(t, e.update), null == r.wheelStartX || null == e.scrollTop && null == e.scrollLeft && !e.scrollToPos || (r.wheelStartX = r.wheelStartY = null), null != e.scrollTop && En(t, e.scrollTop, e.forceScroll), null != e.scrollLeft && In(t, e.scrollLeft, !0, !0), e.scrollToPos) && function(e, t) {
			...
			for (var o = 0; o < 5; o++) {
				var l = !1,
					...
					c = e.doc.scrollTop,
					h = e.doc.scrollLeft;
				if (null != u.scrollTop && (Pn(e, u.scrollTop), Math.abs(e.doc.scrollTop - c) > 1 && (l = !0)), null != u.scrollLeft && (In(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - h) > 1 && (l = !0)), !l) break
			}
			return i
		...
		if (i)
			for (var l = 0; l < i.length; ++l) i[l].lines.length || pe(i[l], "hide");
		if (o)
			for (var s = 0; s < o.length; ++s) o[s].lines.length && pe(o[s], "unhide");
	...
	function li(e, t) {
		...
		return u > 4 && (r.lineDiv.style.display = "none"),
			...
			}(c), M(r.cursorDiv), M(r.selectionDiv), r.gutters.style.height = r.sizer.style.minHeight = 0, s && (r.lastWrapHeight = t.wrapperHeight, r.lastWrapWidth = t.wrapperWidth, ni(e, 400)), r.updateLineNumbers = null, !0
	}

	function si(e, t) {
		for (var r = t.viewport, n = !0;; n = !1) {
			if (n && e.options.lineWrapping && t.oldDisplayWidth != Tr(e)) n && (t.visible = Nn(e.display, e.doc, r));
			else if (r && null != r.top && (r = {
					top: Math.min(e.doc.height + Sr(e.display) - Mr(e), r.top)
				}), t.visible = Nn(e.display, e.doc, r), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo) break;
			if (!li(e, t)) break;
			Tn(e);
			var i = Rn(e);
	...
	function ui(e) {
		...
		e.sizer.style.marginLeft = t + "px", sr(e, "gutterChanged", e)
	}
	...
	function hi(e) {
		...
		if (t.alignWidgets || t.gutters.firstChild && e.options.fixedGutter) {
			for (var n = ln(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = n + "px", l = 0; l < r.length; l++)
				if (!r[l].hidden) {
	...
	function xi(e, t) {
		...
		if (i && c || o && f) {
			if (o && y && a) e: for (var d = t.target, p = s.view; d != u; d = d.parentNode)
				for (var g = 0; g < p.length; g++)
					if (p[g].node == d) {
						e.display.currentWheelTarget = d;
						break e
					} if (i && !r && !h && null != l) return o && f && Pn(e, Math.max(0, u.scrollTop + o * l)), In(e, Math.max(0, u.scrollLeft + i * l)), (!o || o && f) && be(t), void(s.wheelStartX = null);
			if (o && null != l) {
				var v = o * l,
					m = e.doc.scrollTop,
					b = m + s.wrapper.clientHeight;
				v < 0 ? m = Math.max(0, m + v - 50) : b = Math.min(e.doc.height, b + v + 50), ai(e, {
					top: m,
					bottom: b
				})
			}
			mi < 20 && 0 !== t.deltaMode && (null == s.wheelStartX ? (s.wheelStartX = u.scrollLeft, s.wheelStartY = u.scrollTop, s.wheelDX = i, s.wheelDY = o, setTimeout((function() {
				if (null != s.wheelStartX) {
					...
					s.wheelStartX = s.wheelStartY = null, r && (yi = (yi * mi + r) / (mi + 1), ++mi)
				}
	...
	Ci.prototype.primary = function() {
		...
		for (var e = [], t = 0; t < this.ranges.length; t++) e[t] = new Si(nt(this.ranges[t].anchor), nt(this.ranges[t].head));
	...
	function Li(e, t, r) {
		...
		for (var o = 1; o < t.length; o++) {
			...
			if (n && !l.empty() ? a > 0 : a >= 0) {
				...
				o <= r && --r, t.splice(--o, 2, new Si(h ? c : u, h ? u : c))
			}
		}
		return new Ci(t, r)
	}
	...
	function Di(e) {
		...
		})), e.doc.modeFrontier = e.doc.highlightFrontier = e.doc.first, ni(e, 100), e.state.modeGen++, e.curOp && hn(e)
	}
	...
	function Pi(e, t) {
		...
		e.doc = t, t.cm = e, an(e), Ai(e), Ei(e), e.options.direction = t.direction, e.options.lineWrapping || jt(e), e.options.mode = t.modeOption, hn(e)
	}
	...
	function Bi(e, t, r, n) {
		...
		if ((i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = function(e, t) {
				return t ? (zi(e.done), _(e.done)) : e.done.length && !_(e.done).ranges ? _(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(), _(e.done)) : void 0
			}(i, i.lastOp == n))) l = _(o.changes), 0 == tt(t.from, t.to) && 0 == tt(t.from, l.to) ? l.to = Ti(t) : o.changes.push(Ri(e, t));
		else {
			var a = _(i.done);
		...
		i.done.push(r), i.generation = ++i.maxGeneration, i.lastModTime = i.lastSelTime = s, i.lastOp = i.lastSelOp = n, i.lastOrigin = i.lastSelOrigin = t.origin, l || pe(e, "historyAdded")
	}
	...
	function Gi(e, t, r, n) {
		...
		}(e, o, _(i.done), t)) ? i.done[i.done.length - 1] = t : Ui(t, i.done), i.lastSelTime = +new Date, i.lastSelOrigin = o, i.lastSelOp = r, n && !1 !== n.clearRedo && zi(i.undone)
	}
			...
			if (o.ranges) n.push(r ? Ci.prototype.deepCopy.call(o) : o);
				...
				for (var a = 0; a < l.length; ++a) {
					...
					if (s.push({
						...
						for (var h in u)(c = h.match(/^spans_(\d+)$/)) && B(t, Number(c[1])) > -1 && (_(s)[h] = u[h], delete u[h])
				}
			}
		}
		return n
	...
	function $i(e, t, r) {
		...
		Ji(e, Li(e.cm, n, e.sel.primIndex), r)
	}

	function qi(e, t, r, n) {
		var i = e.sel.ranges.slice(0);
		i[t] = r, Ji(e, Li(e.cm, i, e.sel.primIndex), n)
	}
	...
	function eo(e, t, r) {
		(me(e, "beforeSelectionChange") || e.cm && me(e.cm, "beforeSelectionChange")) && (t = function(e, t, r) {
			var n = {
				...
				update: function(t) {
					this.ranges = [];
					for (var r = 0; r < t.length; r++) this.ranges[r] = new Si(st(e, t[r].anchor), st(e, t[r].head))
				},
				origin: r && r.origin
			};
			return pe(e, "beforeSelectionChange", e, n), e.cm && pe(e.cm, "beforeSelectionChange", e.cm, n), n.ranges != t.ranges ? Li(e.cm, n.ranges, n.ranges.length - 1) : t
		}(e, t, r));
		var n = r && r.bias || (tt(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
		to(e, no(e, t, n, !0)), r && !1 === r.scroll || !e.cm || "nocursor" == e.cm.getOption("readOnly") || Dn(e.cm)
	}

	function to(e, t) {
		t.equals(e.sel) || (e.sel = t, e.cm && (e.cm.curOp.updateInput = 1, e.cm.curOp.selectionChanged = !0, ve(e.cm)), sr(e, "cursorActivity", e))
	}
				...
				if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
					...
					if (r) {
						var h = a.find(n < 0 ? 1 : -1),
							f = void 0;
						if ((n < 0 ? c : u) && (h = lo(e, h, -n, h && h.line == t.line ? o : null)), h && h.line == t.line && (f = tt(h, r)) && (n < 0 ? f < 0 : f > 0)) return io(e, h, t, n, i)
					}
					var d = a.find(n < 0 ? -1 : 1);
					return (n < 0 ? u : c) && (d = lo(e, d, n, d.line == t.line ? o : null)), d ? io(e, d, t, n, i) : null
				}
			}
		return t
	}
	...
	function uo(e, t, r) {
		...
		if (!(me(e, "beforeChange") || e.cm && me(e.cm, "beforeChange")) || (t = ao(e, t, !0))) {
	...
	function co(e, t) {
		if (1 != t.text.length || "" != t.text[0] || 0 != tt(t.from, t.to)) {
			var r = Ni(e, t);
			Bi(e, t, r, e.cm ? e.cm.curOp.id : NaN), po(e, t, r, Tt(e, t));
			var n = [];
			Fi(e, (function(e, r) {
				r || -1 != B(n, e.history) || (yo(e.history, t), n.push(e.history)), po(e, t, null, Tt(e, t))
			}))
		}
	}
	...
	function ho(e, t, r) {
		...
		if (!n || r) {
			...
			if (u != s.length) {
				...
				for (var h = me(e, "beforeChange") || e.cm && me(e.cm, "beforeChange"), f = function(r) {
						var n = i.changes[r];
	...
	function fo(e, t) {
		if (0 != t && (e.first += t, e.sel = new Ci($(e.sel.ranges, (function(e) {
				return new Si(et(e.anchor.line + t, e.anchor.ch), et(e.head.line + t, e.head.ch))
	...
	function po(e, t, r, n) {
		...
		if (t.to.line < e.first) fo(e, t.text.length - 1 - (t.to.line - t.from.line));
			...
			t.to.line > o && (t = {
				...
				text: [t.text[0]],
				origin: t.origin
			}), t.removed = Ye(e, t.from, t.to), r || (r = Ni(e, t)), e.cm ? function(e, t, r) {
				var n = e.doc,
					i = e.display,
					o = t.from,
					l = t.to,
				...
				Hi(n, t, r, sn(e)), e.options.lineWrapping || (n.iter(a, o.line + t.text.length, (function(e) {
					var t = Kt(e);
				...
				t.full ? hn(e) : o.line != l.line || 1 != t.text.length || Wi(e.doc, t) ? hn(e, o.line, l.line + 1, u) : fn(e, o.line, "text");
				var c = me(e, "changes"),
					h = me(e, "change");
				if (h || c) {
					var f = {
			...
			}(e.cm, t, n) : Hi(e, t, n), eo(e, r, U), e.cantEdit && oo(e, et(e.firstLine(), 0)) && (e.cantEdit = !1)
		}
	}
	...
	function bo(e, t, r, n) {
		var i = t,
			o = t;
		return "number" == typeof t ? o = Xe(e, lt(e, t)) : i = qe(t), null == i ? null : (n(o, i) && e.cm && fn(e.cm, i, r), o)
	}
	...
	Si.prototype.from = function() {
		...
		removeInner: function(e, t) {
			...
			if (this.size - t < 25 && (this.children.length > 1 || !(this.children[0] instanceof wo))) {
				var s = [];
				this.collapse(s), this.children = [new wo(s)], this.children[0].parent = this
			}
		},
		collapse: function(e) {
				...
				if (e <= o) {
					if (i.insertInner(e, t, r), i.lines && i.lines.length > 50) {
						for (var l = i.lines.length % 25 + 25, s = l; s < i.lines.length;) {
							var a = new wo(i.lines.slice(s, s += 25));
	...
	Co.prototype.clear = function() {
		...
		if (null != n && t) {
			...
			var o = wr(this);
			$e(r, Math.max(0, r.height - o)), e && (Jn(e, (function() {
		...
		this.height = null;
		var i = wr(this) - t;
		i && (Gt(this.doc, n) || $e(n, n.height + i), r && Jn(r, (function() {
			r.curOp.forceUpdate = !0, So(r, n, i), sr(r, "lineWidgetChanged", r, e, qe(n))
		})))
	}, ye(Co);
	var Lo = 0,
		ko = function(e, t) {
	...
	function To(e, t, r, n, i) {
		if (n && n.shared) return function(e, t, r, n, i) {
			...
			return Fi(e, (function(e) {
				s && (n.widgetNode = s.cloneNode(!0)), o.push(To(e, st(e, t), st(e, r), n, i));
		...
		if (e.iter(a, r.line + 1, (function(n) {
				u && o.collapsed && !u.options.lineWrapping && Rt(n) == u.display.maxLine && (s = !0), o.collapsed && a != t.line && $e(n, 0),
					function(e, t, r) {
					...
					}(n, new St(o, a == t.line ? t.ch : null, a == r.line ? r.ch : null), e.cm && e.cm.curOp), ++a
			})), o.collapsed && e.iter(t.line, r.line + 1, (function(t) {
				Gt(e, t) && $e(t, 0)
			})), o.clearOnEnter && he(o, "beforeCursorEnter", (function() {
				return o.clear()
			})), o.readOnly && (xt = !0, (e.history.done.length || e.history.undone.length) && e.clearHistory()), o.collapsed && (o.id = ++Lo, o.atomic = !0), u) {
			if (s && (u.curOp.updateMaxLine = !0), o.collapsed) hn(u, t.line, r.line + 1);
			else if (o.className || o.startStyle || o.endStyle || o.css || o.attributes || o.title)
				for (var c = t.line; c <= r.line; c++) fn(u, c, "text");
	...
	ko.prototype.clear = function() {
		if (!this.explicitlyCleared) {
			...
			for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
				...
				e && !this.collapsed ? fn(e, qe(l), "text") : e && (null != s.to && (i = qe(l)), null != s.from && (n = qe(l))), l.markedSpans = kt(l.markedSpans, s), null == s.from && this.collapsed && !Gt(this.doc, l) && e && $e(l, rn(e.display))
			}
			...
			null != n && e && this.collapsed && hn(e, n, i + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && ro(e.doc)), e && sr(e, "markerCleared", e, this, n, i), t && Yn(e), this.parent && this.parent.clear()
		}
	...
	var Ao = 0,
		Do = function(e, t, r, n, i) {
			...
			null == r && (r = 0), xo.call(this, [new wo([new Xt("", null)])]), this.first = r, this.scrollTop = this.scrollLeft = 0, this.cantEdit = !1, this.cleanGeneration = 1, this.modeFrontier = this.highlightFrontier = r;
			var o = et(r, 0);
	...
	Do.prototype = Z(xo.prototype, {
		...
		setValue: ri((function(e) {
			...
			uo(this, {
				...
				origin: "setValue",
				full: !0
			}, !0), this.cm && Wn(this.cm, 0, 0), Ji(this, ki(t), U)
		})),
		replaceRange: function(e, t, r, n) {
			go(this, e, t = st(this, t), r = r ? st(this, r) : t, n)
		},
		...
		setCursor: ri((function(e, t, r) {
			Zi(this, st(this, "number" == typeof e ? et(e, t || 0) : e), null, r)
		})),
		...
		setSelections: ri((function(e, t, r) {
			if (e.length) {
				for (var n = [], i = 0; i < e.length; i++) n[i] = new Si(st(this, e[i].anchor), st(this, e[i].head || e[i].anchor));
				null == t && (t = Math.min(e.length - 1, this.sel.primIndex)), Ji(this, Li(this.cm, n, t), r)
			}
		})),
		addSelection: ri((function(e, t, r) {
			var n = this.sel.ranges.slice(0);
			n.push(new Si(st(this, e), st(this, t || e))), Ji(this, Li(this.cm, n, n.length - 1), r)
		})),
		...
		replaceSelections: ri((function(e, t, r) {
			...
			s ? Qi(this, s) : this.cm && Dn(this.cm)
		})),
		undo: ri((function() {
			ho(this, "undo")
		})),
		...
		clearHistory: function() {
			var e = this;
			this.history = new Ii(this.history), Fi(this, (function(t) {
		...
		setHistory: function(e) {
			var t = this.history = new Ii(this.history);
			...
			return function(e, t, r, n) {
				...
				return o && i.noHScroll && (o.display.alignWidgets = !0), bo(e, t, "widget", (function(t) {
					...
					if (null == i.insertAt ? r.push(i) : r.splice(Math.min(r.length, Math.max(0, i.insertAt)), 0, i), i.line = t, o && !Gt(e, t)) {
						...
						$e(t, t.height + wr(i)), n && An(o, i.height), o.curOp.forceUpdate = !0
					}
					return !0
		...
		markText: function(e, t, r) {
			return To(this, st(this, e), st(this, t), r, r && r.type || "range")
		},
		...
		copy: function(e) {
			var t = new Do(_e(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
		...
		linkedDoc: function(e) {
			...
			var n = new Do(_e(this, t, r), e.mode || this.modeOption, t, this.lineSep, this.direction);
		...
		unlinkDoc: function(e) {
			...
			if (e.history == this.history) {
				...
				Fi(e, (function(e) {
					return r.push(e.id)
				}), !0), e.history = new Ii(null), e.history.done = Xi(this.history.done, r), e.history.undone = Xi(this.history.undone, r)
			}
		},
				...
				if (n && n.length && window.FileReader && window.File)
					for (var i = n.length, o = Array(i), s = 0, a = function() {
							++s == i && ei(t, (function() {
								...
								uo(t.doc, e), Qi(t.doc, ki(st(t.doc, r), st(t.doc, Ti(e))))
							}))()
						}, u = function(e, r) {
					...
					try {
						...
						if (h) {
							var f;
							if (t.state.draggingText && !t.state.draggingText.copy && (f = t.listSelections()), eo(t.doc, ki(r, r)), f)
								for (var d = 0; d < f.length; ++d) go(t.doc, "", f[d].anchor, f[d].head, "drag");
	...
	for (var zo = {
			...
			63277: "PageDown",
			63302: "Insert"
		}, Bo = 0; Bo < 10; Bo++) zo[Bo + 48] = zo[Bo + 96] = String(Bo);
	for (var Go = 65; Go <= 90; Go++) zo[Go] = String.fromCharCode(Go);
	for (var Uo = 1; Uo <= 12; Uo++) zo[Uo + 111] = zo[Uo + 63235] = "F" + Uo;
	var Vo = {};
	...
	function jo(e) {
		...
		for (var r in e)
			if (e.hasOwnProperty(r)) {
				...
				for (var i = $(r.split(" "), Ko), o = 0; o < i.length; o++) {
					var l = void 0,
						s = void 0;
	...
	function Zo(e, t) {
		for (var r = e.doc.sel.ranges, n = [], i = 0; i < r.length; i++) {
			for (var o = t(r[i]); n.length && tt(o.from, _(n).to) <= 0;) {
				var l = n.pop();
	...
	function sl(e, t, r, n) {
		...
		return "multi" == i && (e.state.keySeq = t), "handled" == i && sr(e, "keyHandled", e, t, r), "handled" != i && "multi" != i || (be(r), xn(e)), !!i
	}
	...
	function cl(e) {
		var t = this;
		if (!(e.target && e.target != t.display.input.getField() || (t.curOp.focus = W(), ge(t, e)))) {
			l && s < 11 && 27 == e.keyCode && (e.returnValue = !1);
			var n = e.keyCode;
			t.display.shift = 16 == n || e.shiftKey;
			var i = al(t, e);
			h && (ul = i ? n : null, i || 88 != n || He || !(y ? e.metaKey : e.ctrlKey) || t.replaceSelection("", null, "cut")), r && !y && !i && 46 == n && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"), 18 != n || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || function(e) {
				var t = e.display.lineDiv;

				function r(e) {
					18 != e.keyCode && e.altKey || (T(t, "CodeMirror-crosshair"), de(document, "keyup", r), de(document, "mouseover", r))
				}
	...
	function fl(e) {
		var t = this;
		if (!(e.target && e.target != t.display.input.getField() || xr(t.display, e) || ge(t, e) || e.ctrlKey && !e.altKey || y && e.metaKey)) {
			var r = e.keyCode,
				n = e.charCode;
	...
	function vl(e) {
		...
		if (!(ge(t, e) || r.activeTouch && r.input.supportsTouch()))
			...
			window.focus(), 1 == i && t.state.selectingText && t.state.selectingText(e), n && function(e, t, r, n, i) {
				...
				return ll(e, _o(o = (1 == t ? "Left" : 2 == t ? "Middle" : "Right") + o, i), i, (function(t) {
				...
				l ? setTimeout(E(Cn, e), 0) : e.curOp.focus = W();
				var i, o = function(e, t, r) {
					...
					u = e.doc.sel;
				e.options.dragDrop && Me && !e.isReadOnly() && "single" == r && (i = u.contains(t)) > -1 && (tt((i = u.ranges[i]).from(), t) < 0 || t.xRel > 0) && (tt(i.to(), t) > 0 || t.xRel < 0) ? function(e, t, r, n) {
					var i = e.display,
						o = !1,
						u = ei(e, (function(t) {
							a && (i.scroller.draggable = !1), e.state.draggingText = !1, e.state.delayingBlurEvent && (e.hasFocus() ? e.state.delayingBlurEvent = !1 : Sn(e)), de(i.wrapper.ownerDocument, "mouseup", u), de(i.wrapper.ownerDocument, "mousemove", c), de(i.scroller, "dragstart", h), de(i.scroller, "drop", u), o || (be(t), n.addNew || _i(e.doc, r, null, null, n.extend), a && !f || l && 9 == s ? setTimeout((function() {
					...
					e.state.draggingText = u, u.copy = !n.moveOnDrag, he(i.wrapper.ownerDocument, "mouseup", u), he(i.wrapper.ownerDocument, "mousemove", c), he(i.scroller, "dragstart", h), he(i.scroller, "drop", u), e.state.delayingBlurEvent = !0, setTimeout((function() {
					...
					var s, a, u = o.sel,
						c = u.ranges;
					n.addNew && !n.extend ? (a = o.sel.contains(r), s = a > -1 ? c[a] : new Si(r, r)) : (s = o.sel.primary(), a = o.sel.primIndex);
					if ("rectangle" == n.unit) n.addNew || (s = new Si(r, r)), r = un(e, t, !0, !0), a = -1;
					else {
						var h = ml(e, r, n.unit);
						s = n.extend ? Yi(s, h.anchor, h.head, n.extend) : h
					}
					n.addNew ? -1 == a ? (a = c.length, Ji(o, Li(e, c.concat([s]), a), {
						scroll: !1,
						origin: "*mouse"
					})) : c.length > 1 && c[a].empty() && "char" == n.unit && !n.extend ? (Ji(o, Li(e, c.slice(0, a).concat(c.slice(a + 1)), 0), {
						scroll: !1,
						origin: "*mouse"
					}), u = o.sel) : qi(o, a, s, V) : (a = 0, Ji(o, new Ci([s], 0), V), u = o.sel);
					var f = r;
						...
						if (0 != tt(f, t))
							if (f = t, "rectangle" == n.unit) {
								for (var i = [], l = e.options.tabSize, c = R(Xe(o, r.line).text, r.ch, l), h = R(Xe(o, t.line).text, t.ch, l), d = Math.min(c, h), p = Math.max(c, h), g = Math.min(r.line, t.line), v = Math.min(e.lastLine(), Math.max(r.line, t.line)); g <= v; g++) {
									var m = Xe(o, g).text,
										y = j(m, d, l);
									d == p ? i.push(new Si(et(g, y), et(g, y))) : m.length > y && i.push(new Si(et(g, y), et(g, j(m, p, l))))
								}
								i.length || i.push(new Si(r, r)), Ji(o, Li(e, u.ranges.slice(0, a).concat(i), a), {
									origin: "*mouse",
									scroll: !1
								}), e.scrollIntoView(t)
							} else {
								...
								S[a] = function(e, t) {
									...
									var f = o[u + (a ? -1 : 0)],
										...
										p = d ? f.from : f.to,
										g = d ? "after" : "before";
									return r.ch == p && r.sticky == g ? t : new Si(new et(r.line, p, g), n)
								}(e, new Si(st(o, C), b)), Ji(o, Li(e, S, a), V)
							}
					}
					...
					function m(t) {
						e.state.selectingText = !1, g = 1 / 0, t && (be(t), i.input.focus()), de(i.wrapper.ownerDocument, "mousemove", y), de(i.wrapper.ownerDocument, "mouseup", b), o.history.lastSelOrigin = null
					}
					var y = ei(e, (function(e) {
							0 !== e.buttons && Le(e) ? v(e) : m(e)
						})),
						b = ei(e, m);
					e.state.selectingText = b, he(i.wrapper.ownerDocument, "mousemove", y), he(i.wrapper.ownerDocument, "mouseup", b)
				}(e, n, t, o)
			}(t, n, o, e) : Se(e) == r.scroller && be(e) : 2 == i ? (n && _i(t.doc, n), setTimeout((function() {
				return r.input.focus()
			}), 20)) : 3 == i && (S ? t.display.input.onContextMenu(e) : Sn(t)))
		}
	}
	...
	function ml(e, t, r) {
		...
		if ("line" == r) return new Si(et(t.line, 0), st(e.doc, et(t.line + 1, 0)));
		var n = r(e, t);
	...
	function yl(e, t, r, n) {
		...
		for (var a = 0; a < e.display.gutterSpecs.length; ++a) {
			...
			if (u && u.getBoundingClientRect().right >= i) return pe(e, r, e, Ze(e.doc, o), e.display.gutterSpecs[a].className, t), xe(t)
		}
	}
	...
	function wl(e, t) {
		...
		}(e, t) || ge(e, t, "contextmenu") || S || e.display.input.onContextMenu(t)
	}
	...
	function Tl(e) {
		e.options.lineWrapping ? (H(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (T(e.display.wrapper, "CodeMirror-wrap"), jt(e)), an(e), hn(e), zr(e), setTimeout((function() {
			return Gn(e)
		}), 100)
	}
	...
	function Ml(e, t) {
		...
		for (var u in o.wrapper.CodeMirror = this, xl(this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), Kn(this), this.state = {
					keyMaps: [],
					overlays: [],
					modeGen: 0,
					overwrite: !1,
				...
				function(e) {
					var t = e.display;
					he(t.scroller, "mousedown", ei(e, vl)), he(t.scroller, "dblclick", l && s < 11 ? ei(e, (function(t) {
						if (!ge(e, t)) {
							var r = un(e, t);
					...
					he(t.scroller, "touchstart", (function(i) {
						...
						if (n && !xr(t, r) && null != n.left && !n.moved && new Date - n.start < 300) {
							...
							o = !n.prev || a(n, n.prev) ? new Si(l, l) : !n.prev.prev || a(n, n.prev.prev) ? e.findWordAt(l) : new Si(et(l.line, 0), st(e.doc, et(l.line + 1, 0))), e.setSelection(o.anchor, o.head), e.focus(), be(r)
						}
						i()
					})), he(t.scroller, "touchcancel", i), he(t.scroller, "scroll", (function() {
						t.scroller.clientHeight && (Pn(e, t.scroller.scrollTop), In(e, t.scroller.scrollLeft, !0), pe(e, "scroll", e))
						...
						over: function(t) {
							ge(e, t) || (! function(e, t) {
								...
								if (r) {
									...
									yn(e, r, n), e.display.dragCursor || (e.display.dragCursor = O("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)), N(e.display.dragCursor, n)
								}
							}(e, t), Ce(t))
						},
						start: function(t) {
							return function(e, t) {
								if (l && (!e.state.draggingText || +new Date - Wo < 100)) Ce(t);
								else if (!ge(e, t) && !xr(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), t.dataTransfer.effectAllowed = "copyMove", t.dataTransfer.setDragImage && !f)) {
					...
					he(u, "keyup", (function(t) {
						return hl.call(e, t)
					})), he(u, "keydown", ei(e, cl)), he(u, "keypress", ei(e, fl)), he(u, "focus", (function(t) {
						return Ln(e, t)
					})), he(u, "blur", (function(t) {
						return kn(e, t)
					}))
				}(this), Io(), Xn(this), this.curOp.forceUpdate = !0, Pi(this, n), t.autofocus && !m || this.hasFocus() ? setTimeout((function() {
					r.hasFocus() && !r.state.focused && Ln(r)
				}), 20) : kn(this), Ll) Ll.hasOwnProperty(u) && Ll[u](this, t[u], Cl);
		fi(this), t.finishInit && t.finishInit(this);
		for (var c = 0; c < Nl.length; ++c) Nl[c](this);
		Yn(this), a && t.lineWrapping && "optimizelegibility" == getComputedStyle(o.lineDiv).textRendering && (o.lineDiv.style.textRendering = "auto")
	}
	...
	function Ol(e, t, r, n) {
		...
		if (n || /\S/.test(s.text)) {
			if ("smart" == r && ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == G || u > 150)) {
				if (!n) return;
				r = "prev"
			}
		} else u = 0, r = "not";
		...
		if (f < u && (h += Y(u - f)), h != c) return go(o, h, et(t, 0), et(t, c.length), "+input"), s.stateAfter = null, !0;
	...
	function Wl(e, t, r, n, i) {
		...
		for (var h = e.curOp.updateInput, f = n.ranges.length - 1; f >= 0; f--) {
			var d = n.ranges[f],
				p = d.from(),
				g = d.to();
			d.empty() && (r && r > 0 ? p = et(p.line, p.ch - r) : e.state.overwrite && !s ? g = et(g.line, Math.min(Xe(o, g.line).text.length, g.ch + _(a).length)) : s && Al && Al.lineWise && Al.text.join("\n") == a.join("\n") && (p = g = et(p.line, 0)));
			var v = {
				from: p,
				to: g,
		...
		t && !s && Fl(e, t), Dn(e), e.curOp.updateInput < 2 && (e.curOp.updateInput = h), e.curOp.typing = !0, e.state.pasteIncoming = e.state.cutIncoming = -1
	}
		...
		if (e.options.electricChars && e.options.smartIndent)
			for (var r = e.doc.sel, n = r.ranges.length - 1; n >= 0; n--) {
				...
				if (!(i.head.ch > 100 || n && r.ranges[n - 1].head.line == i.head.line)) {
					...
					} else o.electricInput && o.electricInput.test(Xe(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = Ol(e, i.head.line, "smart"));
	...
	function Il() {
		...
		return a ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), g && (e.style.border = "1px solid black"), El(e), t
	}
	...
	function Vl(e, t, r) {
		...
		if (t == e.display.lineDiv) {
			if (!(n = e.display.lineDiv.childNodes[r])) return Ul(e.clipPos(et(e.display.viewTo - 1)), !0);
			t = null, r = 0
		} else
	...
	function Kl(e, t, r) {
		...
		for (var f = s.nextSibling, d = l ? l.nodeValue.length - r : 0; f; f = f.nextSibling) {
			if (h = c(f, f.firstChild, 0)) return Ul(et(h.line, h.ch - d), i);
			d += f.textContent.length
		}
		for (var p = s.previousSibling, g = r; p; p = p.previousSibling) {
			if (h = c(p, p.firstChild, -1)) return Ul(et(h.line, h.ch + g), i);
	...
	Bl.prototype.init = function(e) {
			...
			if (o(e) && !ge(n, e)) {
				if (n.somethingSelected()) Dl({
					...
					Dl({
						...
						n.setSelections(t.ranges, 0, U), n.replaceSelection("", null, "cut")
					}))
				}
				if (e.clipboardData) {
				...
				var s = Il(),
					a = s.firstChild;
				n.display.lineSpace.insertBefore(s, n.display.lineSpace.firstChild), a.value = Al.text.join("\n");
				var u = W();
		...
		i.contentEditable = !0, El(i, n.options.spellcheck, n.options.autocorrect, n.options.autocapitalize), he(i, "paste", (function(e) {
			!o(e) || ge(n, e) || Hl(e, n) || s <= 11 && setTimeout(ei(n, (function() {
		...
		if (t.display.viewTo == t.display.viewFrom || i.line >= t.display.viewTo || o.line < t.display.viewFrom) e.removeAllRanges();
			...
			if (!l || l.bad || !s || s.bad || 0 != tt(ot(l, s), i) || 0 != tt(it(l, s), o)) {
				var a = t.display.view,
					u = i.line >= t.display.viewFrom && Gl(t, i) || {
		...
		"nocursor" != this.cm.options.readOnly && (this.selectionInEditor() && W() == this.div || this.showSelection(this.prepareSelection(), !0), this.div.focus())
		...
		if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
			...
			if (!this.composing) {
				...
				r && n && Jn(t, (function() {
					Ji(t.doc, ki(r, n), U), (r.bad || n.bad) && (t.curOp.selectionChanged = !0)
				}))
			}
		}
		...
		l.line == i.viewFrom || 0 == (e = cn(n, l.line)) ? (t = qe(i.view[0].line), r = i.view[0].node) : (t = qe(i.view[e].line), r = i.view[e - 1].node.nextSibling);
		var a, u, c = cn(n, s.line);
		...
		for (var h = n.doc.splitLines(function(e, t, r, n, i) {
				...
				function f(t) {
					if (1 == t.nodeType) {
						...
						if (d) {
							var p = e.findMarks(et(n, 0), et(i + 1, 0), u(+d));
							return void(p.length && (o = p[0].find(0)) && h(Ye(e.doc, o.from, o.to).join(s)))
						}
		...
		for (var y = _(h), b = _(f), w = Math.min(y.length - (1 == h.length ? d : 0), b.length - (1 == f.length ? d : 0)); p < w && y.charCodeAt(y.length - p - 1) == b.charCodeAt(b.length - p - 1);) ++p;
		...
		return h.length > 1 || h[0] || tt(x, C) ? (go(n.doc, h, x, C, "+input"), !0) : void 0
		...
		0 == e.charCode || this.composing || (e.preventDefault(), this.cm.isReadOnly() || ei(this.cm, Wl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
	}, Bl.prototype.readOnlyChanged = function(e) {
		this.div.contentEditable = String("nocursor" != e)
	}, Bl.prototype.onContextMenu = function() {}, Bl.prototype.resetPosition = function() {}, Bl.prototype.needsContentAttribute = !0;
	var jl = function(e) {
	...
	jl.prototype.init = function(e) {
				...
				if (!ge(n, e)) {
					if (n.somethingSelected()) Dl({
						...
						Dl({
							lineWise: !0,
							text: t.text
						}), "cut" == e.type ? n.setSelections(t.ranges, null, U) : (r.prevInput = "", i.value = t.text.join("\n"), P(i))
					}
			...
			e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild), g && (i.style.width = "0px"), he(i, "input", (function() {
				...
				ge(n, e) || Hl(e, n) || (n.state.pasteIncoming = +new Date, r.fastPoll())
			...
			var e = this,
				...
				r = this.textarea,
				n = this.prevInput;
			if (this.contextMenuPending || !t.state.focused || We(r) && !n && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq) return !1;
			var i = r.value;
			...
			if (o && !h) {
				r.options.resetSelectionOnContextMenu && -1 == r.doc.sel.contains(o) && ei(r, Ji)(r.doc, ki(o), U);
			...
			function m() {
				if (t.contextMenuPending == m && (t.contextMenuPending = !1, t.wrapper.style.cssText = d, i.style.cssText = f, l && s < 9 && n.scrollbars.setScrollTop(n.scroller.scrollTop = u), null != i.selectionStart)) {
					...
					var e = 0,
						o = function() {
							n.selForContextMenu == r.doc.sel && 0 == i.selectionStart && i.selectionEnd > 0 && "​" == t.prevInput ? ei(r, so)(r) : e++ < 10 ? n.detectingSelectAll = setTimeout(o, 500) : (n.selForContextMenu = null, n.input.reset())
						};
		...
		function(e) {
			...
			e.defineOption = r, e.Init = Cl, r("value", "", (function(e, t) {
				...
				if (e.doc.lineSep = t, t) {
					...
					for (var i = r.length - 1; i >= 0; i--) go(e.doc, t, r[i], et(r[i].line, r[i].ch + t.length))
				}
			...
			})), r("extraKeys", null), r("configureMouse", null), r("lineWrapping", !1, Tl, !0), r("gutters", [], (function(e, t) {
				e.display.gutterSpecs = di(t, e.options.lineNumbers), gi(e)
				...
				e.display.gutterSpecs = di(e.options.gutters, t), gi(e)
			}), !0), r("firstLineNumber", 1, gi, !0), r("lineNumberFormatter", (function(e) {
				return e
			}), gi, !0), r("showCursorWhenSelecting", !1, vn, !0), r("resetSelectionOnContextMenu", !0), r("lineWiseCopyCut", !0), r("pasteLinesPerSelection", !0), r("selectionsMayTouch", !1), r("readOnly", !1, (function(e, t) {
			...
			}), !0), r("dragDrop", !0, kl), r("allowDropFileTypes", null), r("cursorBlinkRate", 530), r("cursorScrollMargin", 0), r("cursorHeight", 1, vn, !0), r("singleCursorHeightPerLine", !0, vn, !0), r("workTime", 100), r("workDelay", 100), r("flattenSpans", !0, Di, !0), r("addModeClass", !1, Di, !0), r("pollInterval", 100), r("undoDepth", 200, (function(e, t) {
			...
			e.prototype = {
				...
				addOverlay: ti((function(t, r) {
					...
					! function(e, t, r) {
						...
						return e.priority
					})), this.state.modeGen++, hn(this)
				})),
				removeOverlay: ti((function(e) {
					for (var t = this.state.overlays, r = 0; r < t.length; ++r) {
						var n = t[r].modeSpec;
						if (n == e || "string" == typeof e && n.name == e) return t.splice(r, 1), this.state.modeGen++, void hn(this)
					}
				})),
				indentLine: ti((function(e, t, r) {
					"string" != typeof t && "number" != typeof t && (t = null == t ? this.options.smartIndent ? "smart" : "prev" : t ? "add" : "subtract"), Qe(this.doc, e) && Ol(this, e, t, r)
				})),
				indentSelection: ti((function(e) {
					for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
						var i = t[n];
						if (i.empty()) i.head.line > r && (Ol(this, i.head.line, e, !0), r = i.head.line, n == this.doc.sel.primIndex && Dn(this));
						else {
							var o = i.from(),
								l = i.to(),
								s = Math.max(r, o.line);
							r = Math.min(this.lastLine(), l.line - (l.ch ? 0 : 1)) + 1;
							for (var a = s; a < r; ++a) Ol(this, a, e);
							var u = this.doc.sel.ranges;
							0 == o.ch && t.length == u.length && u[n].from().ch > 0 && qi(this.doc, n, new Si(o, u[n].to()), U)
						}
					}
				})),
				...
				addWidget: function(e, t, r, n, i) {
					...
					}, null != (s = On(o, l)).scrollTop && Pn(o, s.scrollTop), null != s.scrollLeft && In(o, s.scrollLeft))
				},
				...
				findPosH: function(e, t, r, n) {
					var i = 1;
					t < 0 && (i = -1, t = -t);
					for (var o = st(this.doc, e), l = 0; l < t && !(o = Rl(this.doc, o, i, r, n)).hitSide; ++l);
					return o
				},
				...
				findPosV: function(e, t, r, n) {
					...
					for (var l = st(this.doc, e), s = 0; s < t; ++s) {
						var a = Xr(this, l, "div");
						if (null == o ? o = a.left : a.left = o, (l = zl(this, a, i, r)).hitSide) break
					}
					return l
				},
				moveV: ti((function(e, t) {
					...
					if (n.extendSelectionsBy((function(l) {
							...
							var a = zl(r, s, e, t);
							return "page" == t && l == n.sel.primary() && An(r, jr(r, a, "div").top - s.top), a
						}), K), i.length)
				...
				toggleOverwrite: function(e) {
					null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? H(this.display.cursorDiv, "CodeMirror-overwrite") : T(this.display.cursorDiv, "CodeMirror-overwrite"), pe(this, "overwriteToggle", this, this.state.overwrite))
				},
				hasFocus: function() {
				...
				scrollIntoView: ti((function(e, t) {
					...
					}(this, e) : Fn(this, e.from, e.to, e.margin)
				})),
				...
				refresh: ti((function() {
					...
					hn(this), this.curOp.forceUpdate = !0, zr(this), Wn(this, this.doc.scrollLeft, this.doc.scrollTop), ui(this.display), (null == e || Math.abs(e - rn(this.display)) > .5 || this.options.lineWrapping) && an(this), pe(this, "refresh", this)
				})),
				swapDoc: ti((function(e) {
					var t = this.doc;
					return t.cm = null, this.state.selectingText && this.state.selectingText(), Pi(this, e), zr(this), this.display.input.reset(), Wn(this, e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, sr(this, "swapDoc", this, t), t
				})),
				phrase: function(e) {
	...
	for (var Yl in Do.prototype) Do.prototype.hasOwnProperty(Yl) && B(Xl, Yl) < 0 && (Ml.prototype[Yl] = function(e) {
		return function() {
			return e.apply(this.doc, arguments)
		}
	}(Do.prototype[Yl]));
	return ye(Do), Ml.inputStyles = {
			textarea: jl,
			contenteditable: Bl
		}, Ml.defineMode = function(e) {
			Ml.defaults.mode || "null" == e || (Ml.defaults.mode = e), Ie.apply(this, arguments)
			...
			t.finishInit = function(r) {
				r.save = n, r.getTextArea = function() {
					...
					r.toTextArea = isNaN, n(), e.parentNode.removeChild(r.getWrapperElement()), e.style.display = "", e.form && (de(e.form, "submit", n), t.leaveSubmitMethodAlone || "function" != typeof e.form.submit || (e.form.submit = i))
				}
